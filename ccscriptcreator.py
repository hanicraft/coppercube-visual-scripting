...
class Widget1():
    ...
    def gui(self, parent):
        ...
        self.set_variable_name = Entry(self.w1,font=("Arial",12),bg="white")
        self.set_variable_name.place(x = 420, y = 50, width = 100, height = 22)
        ...
        self.set_varible.place(x = 520, y = 50, width = 140, height = 22)
    ...
    # def popup(self):
    #     popupWindow = Toplevel(self.w1)
    #     popupWindow.title("setVariable")
    #     popupWindow.geometry("200x100")
    #     alert=Label(popupWindow, text="enter your variable name")
    #     btn = Button(popupWindow, text="ok", command=popupWindow..3)
    #     alert.pack()
    #     btn.pack()
    #     popupWindow.mainloop()
    def setvar(self):
        self.output.insert('1.0', "\n ccbSetCopperCubeVariable("+self.set_variable_name.get()+", value of varible)")
